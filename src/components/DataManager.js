...
function DataManager() {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post("https://sementeriaapi.onrender.com/login", {
        username,
        password,
      });
  ...
  const handleCreate = async () => {
    try {
      await axios.post("https://sementeriaapi.onrender.com/", newData, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchData();
    } catch (error) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`https://sementeriaapi.onrender.com/${editData.id}`, editData, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchData();
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://sementeriaapi.onrender.com/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchData();
    } catch (error) {
